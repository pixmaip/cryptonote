...
const uint64_t CRYPTONOTE_PUBLIC_ADDRESS_BASE58_PREFIX       = 0x4e56;
...
const uint64_t MONEY_SUPPLY                                  = 18446744073709551616;
...
const char     CRYPTONOTE_NAME[]                             = "cryptest";
...
const int      P2P_DEFAULT_PORT                              = 1925;
//TODO This port will be used by the daemon to interact with simlewallet
const int      RPC_DEFAULT_PORT                              = 1926;
